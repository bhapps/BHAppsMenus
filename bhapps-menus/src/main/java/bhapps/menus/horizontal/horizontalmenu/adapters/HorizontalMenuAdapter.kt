        ...
        fun bind(position: Int) {
            ...
            if (horizontalMenuItemsUISettings["horizontal_menu_parent_items_text_size"] as Int != 0) {
                bhapps_menus_menu_horizontal_menu_parent_item_parent_title.textSize =
                    bhapps.menus.helpers.Helpers.getDpToPx(view.context, (horizontalMenuItemsUISettings["horizontal_menu_parent_items_text_size"] as Int))
            }
            ...
            if (horizontalMenuItemsUISettings["horizontal_menu_parent_items_badge_is_visible"] as Boolean) {
                if (
                    ...
                    bhapps.menus.helpers.Helpers.getDpToPx(view.context, (horizontalMenuItemsUISettings["horizontal_menu_parent_items_badge_text_size"] as Int))
                        }
        ...
        fun bind(position: Int) {
            ...
            if (horizontalMenuItemsUISettings["horizontal_menu_child_items_text_size"] as Int != 0) {
                bhapps_menus_menu_horizontal_menu_child_items_title.textSize =
                    bhapps.menus.helpers.Helpers.getDpToPx(view.context, (horizontalMenuItemsUISettings["horizontal_menu_child_items_text_size"] as Int))
            }
            ...
            if (horizontalMenuItemsUISettings["horizontal_menu_child_items_badge_is_visible"] as Boolean) {
                if (
                    ...
                    bhapps.menus.helpers.Helpers.getDpToPx(view.context, (horizontalMenuItemsUISettings["horizontal_menu_child_items_badge_text_size"] as Int))
                        }
        ...
        fun bind(position: Int) {
            ...
            if (horizontalMenuItemsUISettings["horizontal_menu_title_items_text_size"] as Int != 0) {
                bhapps_menus_menu_horizontal_menu_title_item_parent_title.textSize =
                    bhapps.menus.helpers.Helpers.getDpToPx(view.context, (horizontalMenuItemsUISettings["horizontal_menu_title_items_text_size"] as Int))
            }
